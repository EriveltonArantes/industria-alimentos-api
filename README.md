...
| `/api/lotes` | GET / POST / PUT / DELETE | CRUD de Lote |
| `/api/controlequalidades` | GET / POST / PUT / DELETE | CRUD de ControleQualidade |
| `/api/recalls` | GET / POST / PUT / DELETE | CRUD de Recall |
